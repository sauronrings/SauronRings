...
static const int64 MAX_MONEY = 20000 * COIN; // maximum number of coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 960,000 / 250; // 960 blocks found a day.
    }
...
public:
    ...
    {
        CKey key;
        if (!key.SetPubKey(ParseHex("040184710fa689ad5021690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9")))
