...
uint256 hashGenesisBlock("0xede586b5fdc4169d849f25cb466f4efaf8de5fbe2cea9bade0ec31e114a285da");
...
static const int64 nTargetTimespan = 90 * 2; // SauronRings: 1 block
static const int64 nTargetSpacing = 90; // SauronRings: 1.5 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal sauronrings miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SauronRings", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xede586b5fdc4169d849f25cb466f4efaf8de5fbe2cea9bade0ec31e114a285da");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Can you find the hash to find the pieces";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1376403907; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 707273;

        if (fTestNet)
        {
            block.nTime    = 11376403907;
            block.nNonce   = 707273;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x5ec84f341281f408c4bbe6bfe9d3de13c11c21ee37d81f6b738f7073debc6fa3"));
